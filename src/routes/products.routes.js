...
const ProductManager = require("../dao/managers/productManager.mongo")
...
router.get("/", async (req,res) => {
    try {
        ...
        console.log("🚀 ~ file: products.routes.js:31 ~ router.get ~ error:", error)
...
router.get("/filter",async (req,res) => {
    try {
      ...
      console.log("🚀 ~ file: products.routes.js:48 ~ router.get ~ error:", error)
